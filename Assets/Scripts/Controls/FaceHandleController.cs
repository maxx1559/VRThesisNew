    ...
    public class FaceHandleController : IInteractableObject
    {
        ...
        private void Update()
        {
            ...
            if (IsDragged)
            {
                ...
                GrabControl leftGrabControl = GameObject.Find("Grabber_L").GetComponent<GrabControl>();
                GrabControl rightGrabControl = GameObject.Find("Grabber_R").GetComponent<GrabControl>();

                //Check if left hand is sensing, if true do SBS
                if (leftGrabControl.collidedFaceHandle != null && leftGrabControl.HandState.ToString().Equals("TOUCHING") 
                ...
                else if (rightGrabControl.collidedFaceHandle != null && rightGrabControl.HandState.ToString().Equals("TOUCHING") 
